...
/// 输入框封装
class TextFieldCompo extends StatefulWidget {
...
class _MyTextFieldState extends State<TextFieldCompo> {
            ...
            if (_isShowDelete) ...{
              Semantics(
                ...
                child: GestureDetector(
                  child: const Icon(MdiIcons.closeCircle,
            ...
            if (widget.getVCode != null) ...{
              ...
              Theme(
                ...
                child: TextButton(
                  ...
                  child: Text(_clickable ? '获取验证码' : '（$_currentSecond s）'),
                ),
              ),
            },
          ],
